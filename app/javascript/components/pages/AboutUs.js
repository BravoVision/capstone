            ...
            <Col sm="8" md="6" lg="6" xl="3">
              <Card className="indexCard">
                ...
                <CardBody>
                  ...
                  <a href="https://www.linkedin.com/in/gregory-a-shepherd/" target="_blank">
            ...
            <Col sm="8" md="6" lg="6" xl="3">
              <Card className="indexCard">
                ...
                <CardBody>
                  ...
                  <a href="https://www.linkedin.com/in/tameka-stevenson/" target="_blank">
                    <Button className="linkedInButton">LinkedIn</Button>
                  </a>
                </CardBody>
              </Card>
            ...
            <Col sm="8" md="6" lg="6" xl="3">
              <Card className="indexCard">
                ...
                <CardBody>
                  ...
                  <a href="https://www.linkedin.com/in/nat-diaz/" target="_blank">
                    <Button className="linkedInButton">LinkedIn</Button>
                  </a>
                </CardBody>
              </Card>
            ...
            <Col sm="8" md="6" lg="6" xl="3">
              <Card className="indexCard">
                ...
                <CardBody>
                  ...
                  <a href="https://www.linkedin.com/in/zprunella/" target="_blank">
                    <Button className="linkedInButton">LinkedIn</Button>
                  </a>
                </CardBody>
              </Card>
